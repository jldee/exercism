...
def convert_coordinate(coordinate):
    ...
    coordinates_xy = tuple(coordinate)
...
def compare_records(azara_record, rui_record):
    ...
    return azara_coords == rui_record[1]
...
def create_record(azara_record, rui_record):
    ...
    if azara_coords == rui_record[1]:
        match_check = (azara_record + rui_record)
        return match_check
    else:
        return "not a match"
...
def clean_up(combined_record_group):
    ...
    for item_name, redundant_coords, location, coords, color in combined_record_group:
        cleaned_record = (item_name, location, coords, color)
